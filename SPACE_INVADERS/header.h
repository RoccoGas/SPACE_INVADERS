...
enum LEVEL_OPTIONS_E { NO_ERROR_CONTINUE_TO_LEVEL_ONE, NO_ERROR_CONTINUE_TO_LEVEL_TWO, NO_ERROR_CONTINUE_TO_LEVEL_THREE,  DIFFICULTY, SCOREBOARD, QUIT_GAME, RESUME_GAME, QUIT_TO_MENU, BAD_ASSET, BAD_DISPLAY };
