...
enum LEVEL_OPTIONS_E { NO_ERROR_START_GAME, QUIT_GAME, RESUME_GAME, QUIT_TO_MENU, BAD_ASSET, BAD_DISPLAY, BAD_QUEUE, BAD_TIMER };
enum MENU_OPTIONS_E { START_GAME, QUIT, DIFFICULTY_MENU, SCOREBOARD};
